...
import com.agilbudiprasetyo.covid19apps.network.InfoCountry
import com.agilbudiprasetyo.covid19apps.network.InfoService
...
class ChartCountryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataCountry = saveDataCountry.toString() // untuk convert data ke string
